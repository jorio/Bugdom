...
static EffectType	gEffectsTable[] =
{
	...
	{SOUND_BANK_DEFAULT,       SOUND_DEFAULT_FIRECRACKER,  2500, SOUND_MULTIPLE	},  // EFFECT_FIRECRACKER
	...
	{SOUND_BANK_DEFAULT,       SOUND_DEFAULT_RESCUE,        500, SOUND_MULTIPLE	},  // EFFECT_RESCUE
